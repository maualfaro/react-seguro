...
- Name: acceptance.spec.ts >> Criterio 2 — rutas privadas y validación por rol >> [c2] el analista no ve el botón de aprobar
- Location: grading/acceptance.spec.ts:60:3
