...
- Name: acceptance.spec.ts >> Criterio 3 — estados y retroalimentación >> [c3] recorrido con teclado: el formulario de login es navegable
- Location: grading/acceptance.spec.ts:98:3
