...
- Name: acceptance.spec.ts >> Criterio 2 — rutas privadas y validación por rol >> [c2] ruta protegida sin sesión redirige a login
- Location: grading/acceptance.spec.ts:43:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/solicitudes
Call log:
  - navigating to "http://localhost:3000/solicitudes", waiting until "load"
