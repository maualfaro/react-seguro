...
- Name: acceptance.spec.ts >> Criterio 4 — buenas prácticas de seguridad >> [c4] IDOR: analista de A no abre solicitud de B (se comporta como inexistente)
- Location: grading/acceptance.spec.ts:68:3
