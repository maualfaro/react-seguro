...
- Name: acceptance.spec.ts >> Criterio 1 — flujo de autenticación >> [c1] credenciales inválidas no autentican y dan mensaje uniforme
- Location: grading/acceptance.spec.ts:24:3
