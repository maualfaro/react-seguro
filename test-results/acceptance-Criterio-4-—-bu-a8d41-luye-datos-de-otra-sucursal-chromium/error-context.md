...
- Name: acceptance.spec.ts >> Criterio 4 — buenas prácticas de seguridad >> [c4] el listado de un analista no incluye datos de otra sucursal
- Location: grading/acceptance.spec.ts:74:3
